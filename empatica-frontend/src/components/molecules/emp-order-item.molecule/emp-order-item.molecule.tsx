        ...
        <div class="order-body">
          {this.order.discounts && (
            <div class="order-discount-row">
              <p data-translate>ORDER.DISCOUNT.DISCOUNTS</p>
              {this.order.discounts.map(discount => (
                <div class="discount">
                  <p class="name">{discount.name}</p>
                  <p
                    class="amount"
                    data-translate
                    data-translate-value={{ value: discount.value }}
                  >{`ORDER.DISCOUNT.TYPE.${discount.type}`}</p>
                </div>
              ))}
            </div>
          )}
